...
//-------------------------------------------------------------
	...
	void TlsSession::SendHandshakeMsg (uint8_t handshakeType, uint8_t * data, size_t len)
	{
		...
		handshakeHeader[1] = 0x03;
		handshakeHeader[2] = 0x03; // version is always TLS 1.2 (3,3)
	...
	void TlsSession::SendFinishedMsg ()
	{
		...
		finishedPayload[1] = 0;
		finishedPayload[2] = 0;
		finishedPayload[3] = 0x0C; // 12 bytes
		...
		finished[1] = 0x03;
		finished[2] = 0x03; // version is always TLS 1.2 (3,3)
